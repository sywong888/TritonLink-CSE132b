...
CREATE TABLE concentration (degree_number integer, name varchar(255), min_units integer, min_gpa integer, PRIMARY KEY (degree_number, name), FOREIGN KEY (degree_number) REFERENCES ucsd_degree (degree_number));
