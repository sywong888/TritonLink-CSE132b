...
CREATE TABLE ucsd_degree (degree_number integer, degree_type varchar(255) not null, dno integer not null, concentration varchar(255) not null, total_units integer, PRIMARY KEY (degree_number), FOREIGN KEY (dno) REFERENCES department (dno));
...
CREATE TABLE meeting (course_id integer not null, class_id varchar(255) not null, quarter char(2), year integer, day varchar(255), start_time varchar(255), end_time varchar(255), room varchar(255), type varchar(255), mandatory char(1), PRIMARY KEY (course_id, class_id, quarter, year, day, start_time, end_time, room, type), FOREIGN KEY (course_id, class_id, quarter, year) REFERENCES classes(course_id, class_id, quarter, year));
...
CREATE TABLE enroll (ssn char(9) NOT NULL, course_id int NOT NULL, class_id varchar(255) NOT NULL, quarter char(2) NOT NULL, year int NOT NULL, units_taken integer, grade_option varchar(255), status varchar(255), grade varchar(255), PRIMARY KEY (ssn, course_id, class_id, quarter, year), FOREIGN KEY (ssn) REFERENCES student(ssn), FOREIGN KEY (course_id, class_id, quarter, year) REFERENCES classes(course_id, class_id, quarter, year));
