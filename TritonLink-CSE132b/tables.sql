...
CREATE TABLE review_session (course_id integer, class_title varchar(255), quarter char(2), year integer, section_id varchar(255), date varchar(255), time varchar(255), duration integer, PRIMARY KEY (course_id, class_title, quarter, year, section_id, date, time), FOREIGN KEY (course_id, class_title, quarter, year, section_id) REFERENCES section (course_id, class_title, quarter, year, section_id));
